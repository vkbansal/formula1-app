import { z } from 'zod';
import { Season, Race, Circuit, DriverStanding, ConstructorStanding, Constructor, Driver, } from './db.js';
export const Team = Constructor.pick({
    constructorRef: true,
    name: true,
    nationality: true,
}).extend({
    drivers: z.array(Driver.pick({
        driverRef: true,
        nationality: true,
    }).extend({
        name: z.string(),
...
export const SeasonRound = Race.pick({
    ...
    driverStandings: z.array(DriverStanding.pick({
        points: true,
        position: true,
        wins: true,
    }).extend({
    ...
    constructorStandings: z.array(ConstructorStanding.pick({
        points: true,
        position: true,
        wins: true,
    }).extend({
